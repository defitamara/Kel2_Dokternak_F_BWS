               ...
               <!-- Tulis Artikel -->
                    <div class="btn_tulis">
                            <div class="items-link f-center">
                                <a href="/penyuluh/artikel" class="genric-btn primary">DAFTAR ARTIKEL</a>
                                </div>
                     </div>
                     <aside class="single_sidebar_widget post_category_widget">
                        ...
                        <ul class="list cat-list">
                            ...
                            <li>
                                <a href="/penyuluh/artikel/cari?cari={{ $data_katartikel->kategori_artikel }}" class="d-flex">
                  ...
                  <aside class="single_sidebar_widget popular_post_widget">
                     ...
                     <div class="media post_item">
                         ...
                         <div class="media-body">
                              <h6><a href="/penyuluh/artikel/{{ $data_artikel->id_artikel }}/detail/">{{ $data_artikel->judul }}</a></h6>
