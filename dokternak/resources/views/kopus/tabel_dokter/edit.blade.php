        ...
        <p class="text-muted">Dokter Hewan, Paramedis, dan Petugas Inseminator Buatan</p>
          <div class="card shadow">
            <div class="card-header">
                ...
                <b><a href="/dbkopus/tabel_dokter"> Data Petugas / </a></b>
                <b>Form</b>
            </div>
            <div class="card-body">
              <form class="needs-validation" id="dokter_form" method="POST"  enctype="multipart/form-data"
                        action="{{ route('tabel_dokter.update',$dtdokter->id_dokter) }}">
                            {!! csrf_field() !!}
                ...
                <a href="{{ route('tabel_dokter.index') }}"><button class="btn btn-secondary"
