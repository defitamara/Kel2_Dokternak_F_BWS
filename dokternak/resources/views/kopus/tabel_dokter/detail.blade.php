              ...
              <div class="ms-auto text-end">
                <nav aria-label="breadcrumb">
                  <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="/dbkopus/tabel_dokter">Data Petugas</a></li>
            ...
            @foreach ($dtdokter as $item)
              <div class="card-body">
                <div class="card-title">
                  ...
                  <a href="/dbkopus/tabel_dokter">Data Petugas / </a>
                  {{ $item->nama_dokter }}</b>
                </div>
                <div class="d-flex flex-row comment-row mt-0">
                  <div class="comment-text w-100">
                    ...
                    <div class="comment-footer float-end">
                      <a href="{{ route('tabel_dokter.index') }}"><button
                        type="button"
                        class="btn btn-secondary btn-sm text-white">
                        Kembali
                      </button></a>
                      <a href="{{ route('tabel_dokter.edit',$item->id_dokter) }}"><button
                        type="button"
