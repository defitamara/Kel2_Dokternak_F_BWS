            ...
            <div class="col-15">
              ...
              <div class="card shadow">
                <div class="card-body">
                  ...
                  {{-- Button in header --}}
                  <a href="{{ route('tabel_dokpus.create') }}" class="card-title">
                    <button type="button" class="btn btn-primary">
                      Tambah Data +
                    </button>
                  </a>
                  <a href="/cetak_pdf/tabel_dokpus" class="card-title" target="_blank">
                    ...
                    <table id="zero_config" class="table table-striped table-bordered">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>
                            <div class="btn-group">
                              <a href="{{ route('tabel_dokpus.edit',$item->id_dp)}}" class="btn btn-cyan btn-sm text-white">Edit
                                <span class="fas fa-edit"></span></a>
                              <form action="{{ route('tabel_dokpus.destroy',$item->id_dp)}}" method="POST">
                              @csrf
                                  @method('DELETE')
