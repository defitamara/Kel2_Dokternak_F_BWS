...
<div class="page-wrapper">
  <div class="container-fluid">
    <div class="row justify-content-center">
      <div class="col-12">
        <h2 class="page-title">Form Edit Data Puskeswan</h2>
        <p class="text-muted">Anda hanya dapat mengedit data Puskeswan tempat anda bertugas</p>
          <div class="card shadow">
            <div class="card-header">
                <b><a href="/dbkopus">Dashboard / </a></b>
                <b><a href="/dbkopus/dta_puskeswan"> Data Puskeswan / </a></b>
                <b>Form</b>
            </div>
            <div class="card-body">
              <form class="needs-validation" id="puskeswan_form" method="POST" enctype="multipart/form-data"
              action="{{ route('tabel_puskeswan.update',$puskeswan->id_puskeswan) }}">
                  {!! csrf_field() !!}
                ...
                <a href="{{ route('tabel_puskeswan.index') }}"><button class="btn btn-secondary"
