...
<html lang="en-US">
  <head>
    ...
    <title>Dokternak.id - Detail Penyuluh</title>
        ...
        <div class="page-header page-header-small" filter-color="blue">
          ...
          <div class="container">
            <div class="content-center">
              <div class="cc-profile-image"><a href="#"><img src="/data/data_penyuluh/{{ $penyuluh->foto }}" /></a></div>
              <div class="h2 title">{{ $penyuluh->nama_penyuluh }}</div>
              <p class="capt">PENYULUH PERIKANAN</p>
              <a class="genric-btn primary" href="https://api.whatsapp.com/send?phone={{ $penyuluh->telpon }}">WhatsApp</a>
            ...
            <div class="col-lg-6 col-md-12">
              <div class="card-body">
                ...
                <div class="row mt-3">
                  ...
                  <div class="col-sm-8">{{ $penyuluh->jenis_kelamin }}</div>
                </div>
                <div class="row mt-3">
                ...
                <div class="row mt-3">
                  ...
                  <div class="col-sm-8">{{ $penyuluh->alamat }}</div>
                </div>
                <div class="row mt-3">
                  <div class="col-sm-4"><strong class="text-uppercase">Email</strong></div>
                  <div class="col-sm-8">{{ $penyuluh->email }}</div>
                </div>
              </div>
            </div>
          </div>
