              ...
              <div class="ms-auto text-end">
                <nav aria-label="breadcrumb">
                  <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="/dbstaf/dt_staf">Data Staf</a></li>
            ...
            @foreach ($dtstaf as $item)
              <div class="card-body">
                <div class="card-title">
                  ...
                  <a href="/dbstaf/dt_staf">Data Staf / </a>
                  {{ $item->nama_staf }}</b>
                </div>
                <div class="d-flex flex-row comment-row mt-0">
                  <div class="comment-text w-100">
                    ...
                    <div class="comment-footer float-end">
                      <a href="{{ route('dt_staf.index') }}"><button
                        type="button"
                        class="btn btn-secondary btn-sm text-white">
                        Kembali
                      </button></a>
                      <a href="{{ route('dt_staf.edit',$item->id_staf) }}"><button
                        type="button"
