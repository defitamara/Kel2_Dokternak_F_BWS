              ...
              <div class="ms-auto text-end">
                <nav aria-label="breadcrumb">
                  <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="/dbstaf/dt_informasi">Data Informasi</a></li>
            ...
            @foreach ($informasi as $item)
              <div class="card-body">
                <div class="card-title">
                  ...
                  <a href="/dbstaf/dt_informasi">Data Informasi / </a>
                  {{ $item->judul }}</b>
                </div>
                <div class="d-flex flex-row comment-row mt-0">
                  ...
                  <div class="comment-text w-100">
                    ...
                    <div class="comment-footer float-end">
                      <a href="{{ route('dt_informasi.index') }}"><button
                        type="button"
                        class="btn btn-secondary btn-sm text-white">
                        Kembali
                      </button></a>
                      <a href="{{ route('dt_informasi.edit',$item->id_info) }}"><button
                        type="button"
