        ...
        <p class="text-muted">Tambah data Puskeswan baru melalui form dibawah ini!</p>
          <div class="card shadow">
            <div class="card-header">
                ...
                <b><a href="/dbstaf/dt_puskeswan"> Data Puskeswan / </a></b>
                <b>Form</b>
            </div>
            <div class="card-body">
              <form class="needs-validation" id="puskeswan_form" method="POST" enctype="multipart/form-data"
              action="{{ isset($puskeswan) ? route('dt_puskeswan.update',$puskeswan->id_puskeswan) : 
              route('dt_puskeswan.store') }}">
                  {!! csrf_field() !!}
                ...
                <a href="{{ route('dt_puskeswan.index') }}"><button class="btn btn-secondary"
