          ...
          <div class="card shadow">
            ...
            <div class="card-body">
              <form class="needs-validation" id="admin_form" method="POST" enctype="multipart/form-data"
                            action="{{ isset($data) ? route('dt_user_kopus.update',$data->id) : 
                ...
                <div class="form-row">
                  ...
                  <a href="{{ route('dt_user_kopus.ubahpw',$data->id) }}"><button class="btn btn-secondary"
                    type="button">Ubah Password</button></a>
                  <a href="{{ route('dt_user_kopus.index') }}"><button class="btn btn-secondary"
                ...
                <div class="form-row">
                  ...
                  <label for="1">- Anda <b>tidak bisa melihat password versi asli</b> untuk alasan keamanan akun koordinator</label><br>
                  <label for="2">- Jika koordinator melupakan passwordnya, anda dapat menekan tombol <b>ubah password</b> untuk <b>membuat password baru</b></label>
                </div>
              </form>
            </div> <!-- /.card-body -->
