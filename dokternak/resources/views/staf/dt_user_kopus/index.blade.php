...
<html dir="ltr" lang="en">
  <head>
    ...
    <title>Data User Koordinator Puskeswan</title>
    <!-- Favicon icon -->
    <link
      rel="icon"
      type="image/png"
        ...
        <div class="page-breadcrumb">
          <div class="row">
            <div class="col-12 d-flex no-block align-items-center">
              <h4 class="page-title">Data User Koordinator Puskeswan</h4>
              <div class="ms-auto text-end">
                <nav aria-label="breadcrumb">
                  <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="/dbstaf">Dashboard</a></li>
                    <li class="breadcrumb-item active" aria-current="page">
                      Data User Koordinator Puskeswan
                    </li>
                  </ol>
                </nav>
              </div>
            ...
            <div class="col-15">
              ...
              <div class="card shadow">
                <div class="card-body">
                  ...
                  <a href="{{ route('dt_user_kopus.create') }}" class="card-title">
                    <button type="button" class="btn btn-primary">
                      Tambah Data +
                    </button>
                  </a>
                  <a href="/cetak_pdf/dt_user_kopus" class="card-title" target="_blank">
                    ...
                    <table id="zero_config" class="table table-striped table-bordered">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>
                            <div class="btn-group">
                              <a href="{{ route('dt_user_kopus.edit',$item->id) }}" class="btn btn-cyan btn-sm text-white">Edit
                                <span class="fas fa-edit"></span></a>
                              <form action="{{ route('dt_user_kopus.destroy',$item->id)}}" method="POST">
                              @csrf
                                  @method('DELETE')
                                  <button type="submit" class="btn btn-danger btn-sm text-white" 
                                  onclick="return confirm('Apakah Anda yakin ingin menghapus akun koordinator bernama {{ $item->nama }} ?')">Hapus
