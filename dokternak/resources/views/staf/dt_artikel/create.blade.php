        ...
        <p class="text-muted">Artikel baru yang anda simpan akan langsung tampil pada website</p>
          <div class="card shadow">
            <div class="card-header">
                ...
                <b><a href="/dbstaf/dt_artikel"> Data Artikel / </a></b>
                <b>Form</b>
            </div>
            <div class="card-body"> 
              <form class="needs-validation" id="artikel_form" method="POST" enctype="multipart/form-data"
                action="{{ isset($artikel) ? route('dt_artikel.update',$artikel->id_artikel) : 
                route('dt_artikel.store') }}">
                {!! csrf_field() !!}
                ...
                <div class="form-row">
                  <div class="col-md-12 mb-3">
                    ...
                    <input class="form-control" id="judul" name="judul" minlength="5" type="text" placeholder="Masukkan judul artikel (Min: 3 kata)"
                ...
                <div class="form-row">
                  <div class="col-md-12 mb-3">
                    ...
                    <input list="id_ktg" class="form-control {{ $errors->has('id_ktg') ? 'is-invalid' : ''}}" placeholder='Pilih kategori/jenis hewan (Hanya angka. Contoh: 1)' value="{{ isset($artikel) ? $artikel->id_ktg : '' }}" name="id_ktg" >
                ...
                <div class="form-row">
                  ...
                  <a href="{{ route('dt_artikel.index') }}"><button class="btn btn-secondary"
