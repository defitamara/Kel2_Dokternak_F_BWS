        ...
        <p class="text-muted">Data yang bisa anda edit dibawah ini hanya email. Untuk mengubah password, tekan tombol "Ubah Password"!</p>
          <div class="card shadow">
            <div class="card-header">
                ...
                <b>{{ $datapetugas->name }}</b>
            </div>
            <div class="card-body">
              <form class="needs-validation" id="admin_form" method="POST" enctype="multipart/form-data"
                            action="{{ isset($datapetugas) ? route('dt_user_petugas.update',$datapetugas->id) : 
                ...
                <div class="form-row">
                  ...
                  <a href="{{ route('dt_user_petugas.ubahpw',$datapetugas->id) }}"><button class="btn btn-secondary"
                ...
                <div class="form-row">
                  ...
                  <label for="0">- Perubahan email juga akan diterapkan secara otomatis pada data petugas terkait</label><br>
                  <label for="1">- Anda <b>tidak bisa melihat password versi asli</b> untuk alasan keamanan akun petugas</label><br>
                  <label for="2">- Jika petugas melupakan passwordnya, anda dapat menekan tombol <b>ubah password</b> untuk <b>membuat password baru</b></label>
                </div>
              </form>
            </div> <!-- /.card-body -->
