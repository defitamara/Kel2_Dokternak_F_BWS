              ...
              <div class="ms-auto text-end">
                <nav aria-label="breadcrumb">
                  <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="/dbstaf/dt_penyuluh">Data Penyuluh</a></li>
            ...
            @foreach ($dtpenyuluh as $item)
              <div class="card-body">
                <div class="card-title">
                  ...
                  <a href="/dbstaf/dt_penyuluh">Data Penyuluh / </a>
                ...
                <div class="d-flex flex-row comment-row mt-0">
                  <div class="comment-text w-100">
                    ...
                    <div class="comment-footer float-end">
                      <a href="{{ route('dt_penyuluh.index') }}"><button
                        type="button"
                        class="btn btn-secondary btn-sm text-white">
                        Kembali
                      </button></a>
                      <a href="{{ route('dt_penyuluh.edit',$item->id_penyuluh) }}"><button
                        type="button"
