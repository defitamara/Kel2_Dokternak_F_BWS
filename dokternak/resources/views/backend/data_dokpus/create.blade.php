  ...
  <div class="container-fluid">
    <div class="row justify-content-center">
      <div class="col-12">
        ...
        <p class="text-muted">Tambahkan data petugas puskeswan baru melalui form dibawah ini!</p>
          <div class="card shadow">
            <div class="card-header">
                <b><a href="/dashboard">Dashboard / </a></b>
                <b><a href="/dashboard/data_dokpus"> Data Petugas Puskeswan / </a></b>
                <b>Form</b>
            </div>
            <div class="card-body">
              <form class="needs-validation" id="dokpus_form" method="POST" enctype="multipart/form-data"
              action="{{ isset($data_dokpus) ? route('data_dokpus.update',$data_dokpus->id_dp) : 
              route('data_dokpus.store') }}">
                  {!! csrf_field() !!}
                  {!! isset($data_dokpus) ? method_field('PUT') : '' !!}
                <input type="hidden" name="id_dp" value="{{ isset($data_dokpus) ? $data_dokpus->id_dp : '' }}"> <br/>
                <div class="form-row">
                  <div class="col-md-6 mb-3">
                    <label for="validationCustom3">ID Puskeswan</label>
                    <input list="id_puskeswan" class="form-control {{ $errors->has('id_puskeswan') ? 'is-invalid' : ''}}" placeholder='Masukkan id puskeswan (hanya angka)' value="{{ isset($data_dokpus) ? $data_dokpus->id_puskeswan : '' }}" name="id_puskeswan" >
                ...
                <div class="form-row">
                  <div class="col-md-6 mb-3">
                      ...
                      <input list="id_dokter" class="form-control {{ $errors->has('id_dokter') ? 'is-invalid' : ''}}" placeholder='Masukkan id petugas (hanya angka)' value="{{ isset($data_dokpus) ? $data_dokpus->id_dokter : '' }}" name="id_dokter" >
                ...
                <a href="{{ route('data_dokpus.index') }}"><button class="btn btn-secondary"
