        ...
        <p class="text-muted">Tambahkan data kopus baru melalui form dibawah ini!</p>
          <div class="card shadow">
            <div class="card-header">
                ...
                <b><a href="/dashboard/data_user_kopus"> Data Akun Kopus / </a></b>
                <b>Form</b>
            </div>
            <div class="card-body">
              <form class="needs-validation" id="admin_form" method="POST" enctype="multipart/form-data"
                            action="{{ isset($data) ? route('data_user_kopus.update',$data->id) : 
                            route('data_user_kopus.store') }}">
                                {!! csrf_field() !!}
              ...
              <div class="form-row">
                ...
                <a href="{{ route('data_user_kopus.ubahpw',$data->id) }}"><button class="btn btn-secondary"
                  type="button">Ubah Password</button></a>
                <a href="{{ route('data_user_kopus.index') }}"><button class="btn btn-secondary"
              ...
              <div class="form-row">
                ...
                <label for="1">- Anda <b>tidak bisa melihat password versi asli</b> untuk alasan keamanan akun kopus</label><br>
                <label for="2">- Jika kopus melupakan passwordnya, anda dapat menekan tombol <b>ubah password</b> untuk <b>membuat password baru</b></label>
              </div>
            </form>
            </div> <!-- /.card-body -->
          </div> <!-- /.card -->
