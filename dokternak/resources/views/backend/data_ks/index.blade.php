        ...
        <div class="page-breadcrumb">
          <div class="row">
            <div class="col-12 d-flex no-block align-items-center">
              <h4 class="page-title">Data Kritik dan Saran</h4>
            ...
            <div class="col-15">
              ...
              <div class="card shadow">
                <div class="card-body">
                  ...
                  {{-- Button in header --}}
                  <a href="{{ route('data_ks.create') }}" class="card-title">
                    <button type="button" class="btn btn-primary">
                      Tambah Data +
                    </button>
                  </a>
                  <a href="/cetak_pdf/data_ks" class="card-title" target="_blank">
                    ...
                    <table id="zero_config" class="table table-striped table-bordered">
                      ...
                      <tbody>
                        ...
                        <tr>
                          <td>{{ $no++ }}</td>
                          <td>{{ $item->tanggal }}</td>
                          <td>{!!\Illuminate\Support\Str::limit($item->komentar, 50)!!} <a href="/dashboard/data_ks/{{ $item->id_ks }}/detail/" class="more-btn">  <strong> Read more » </strong></a></td>
                          <td>{{ $item->nama }}</td>
                          <td>{{ $item->email_hp }}</td>
                          <td>{{ $item->pekerjaan }}</td>
                          <td>
                            <div class="btn-group">
                              <a href="{{ route('data_ks.edit',$item->id_ks)}}" class="btn btn-cyan btn-sm text-white">Edit
