          ...
          <div class="card shadow">
            ...
            <div class="card-body">
              ...
              <form class="needs-validation" id="dokter_form" method="POST"  enctype="multipart/form-data"
                        action="{{ route('data_staf.update',$data_staf->id_staf) }}">
                            {!! csrf_field() !!}
                ...
                <div class="form-row">
                  <div class="col-md-4 mb-2">
                    ...
                    <div class="form-row">
                      <input type="radio" name="jenis_kelamin" id="laki" value="Laki-Laki" {{ ($data_staf->jenis_kelamin=="Laki-Laki")? "checked" : "" }}>
                      <label for="laki" class="tab-label">Laki-Laki</label> <br>
                      <input type="radio" name="jenis_kelamin" id="perempuan" value="Perempuan" {{ ($data_staf->jenis_kelamin=="Perempuan")? "checked" : "" }}>
                ...
                <div class="form-row">
                  <div class="col-md-12 mb-2">
                    ...
                    <textarea type="text" class="form-control" id="alamat" name="alamat" placeholder="Tuliskan alamat lengkap petugas" required>{{ isset($data_staf) ? $data_staf->alamat : '' }}</textarea>
                ...
                <div class="form-row">
                  <div class="col-md-4 mb-2">
                    ...
                    <input type="file" name="foto" id="foto" class="form-control {{ $errors->has('foto') ? 'is-invalid' : ''}}" value="{{ isset($data_staf) ? $data_staf->foto : '' }}">
                        @if ( $errors->has('foto'))
