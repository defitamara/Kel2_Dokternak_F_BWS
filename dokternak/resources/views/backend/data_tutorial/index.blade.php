        ...
        <div class="page-breadcrumb">
          <div class="row">
            <div class="col-12 d-flex no-block align-items-center">
              <h4 class="page-title">Data Tutorial</h4>
            ...
            <div class="col-15">
              ...
              <div class="card shadow">
                <div class="card-body">
                  ...
                  {{-- Button in header --}}
                  <a href="{{ route('data_tutorial.create') }}" class="card-title">
                    <button type="button" class="btn btn-primary">
                      Tambah Data +
                    </button>
                  </a>
                  <a href="/cetak_pdf/data_tutorial" class="card-title" target="_blank">
                    ...
                    <table id="zero_config" class="table table-striped table-bordered">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>{!!\Illuminate\Support\Str::limit($item->isi , 50)!!} <a href="/dashboard/data_tutorial/{{ $item->id_tutorial }}/detail/" class="more-btn">  <strong> Read more » </strong></a></td>
                          <td><img src="/data/data_tutorial/{{ $item->icon }}" width="200"></td>
                          <td>
                            <div class="btn-group">
                              <a href="{{ route('data_tutorial.edit',$item->id_tutorial)}}" class="btn btn-cyan btn-sm text-white">Edit
