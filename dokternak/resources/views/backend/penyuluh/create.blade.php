        ...
        <p class="text-muted">Tambahkan data penyuluh baru melalui form dibawah ini!</p>
          <div class="card shadow">
            <div class="card-header">
                ...
                <b><a href="/dashboard/dtpenyuluh"> Data Penyuluh / </a></b>
                <b>Form</b>
            </div>
            <div class="card-body">
              <form class="needs-validation" id="penyuluh_form" method="POST"  enctype="multipart/form-data"
                  action="{{ isset($dtpenyuluh) ? route('dtpenyuluh.update',$dtpenyuluh->id_penyuluh) : 
                  route('dtpenyuluh.store') }}">
                      {!! csrf_field() !!}
                ...
                <a href="{{ route('dtpenyuluh.index') }}"><button class="btn btn-secondary"
