...
<html dir="ltr" lang="en">
  <head>
    ...
    <title>Data User Peternak</title>
    <!-- Favicon icon -->
    <link
      rel="icon"
      type="image/png"
        ...
        <div class="page-breadcrumb">
          <div class="row">
            <div class="col-12 d-flex no-block align-items-center">
              <h4 class="page-title">Data User Peternak</h4>
            ...
            <div class="col-15">
              ...
              <div class="card shadow">
                <div class="card-body">
                  ...
                  {{-- Button in header --}}
                  {{-- <a href="{{ route('data_user_peternak.create') }}" class="card-title">
                    <button type="button" class="btn btn-primary">
                      Tambah Data +
                    </button>
                  </a> --}}
                  <a href="/cetak_pdf/data_user_peternak" class="card-title" target="_blank">
                    ...
                    <table id="zero_config" class="table table-striped table-bordered">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>
                            <div class="btn-group">
                              <a href="{{ route('data_user_peternak.edit',$item->id) }}" class="btn btn-cyan btn-sm text-white">Edit
                                <span class="fas fa-edit"></span></a>
                              <form action="{{ route('data_user_peternak.destroy',$item->id)}}" method="POST">
                              @csrf
                                  @method('DELETE')
