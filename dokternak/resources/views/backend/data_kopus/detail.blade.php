              ...
              <div class="ms-auto text-end">
                <nav aria-label="breadcrumb">
                  <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="/dashboard/data_kopus">Data Kopus</a></li>
            ...
            @foreach ($data_kopus as $item)
              <div class="card-body">
                <div class="card-title">
                  ...
                  <a href="/dashboard/data_kopus">Data Kopus / </a>
                  {{ $item->nama_kp }}</b>
                </div>
                <div class="d-flex flex-row comment-row mt-0">
                  <div class="comment-text w-100">
                    ...
                    <div class="comment-footer float-end">
                      <a href="{{ route('data_kopus.index') }}"><button
                        type="button"
                        class="btn btn-secondary btn-sm text-white">
                        Kembali
                      </button></a>
                      <a href="{{ route('data_kopus.edit',$item->id_kp) }}"><button
                        type="button"
