...
<main role="main" class="main-content">
  ...
  <div class="container-fluid">
    <div class="row justify-content-center">
      <div class="col-12">
        <h2 class="page-title">Form Data Petugas</h2>
        <p class="text-muted">Tambahkan data petugas baru melalui form dibawah ini!</p>
          <div class="card shadow">
            ...
            <div class="card-body">
              <form class="needs-validation" id="admin_form" method="POST" enctype="multipart/form-data"
                            action="{{ isset($data) ? route('data_user_petugas.update',$data->id) : 
              ...
              <div class="form-row">
                ...
                <a href="{{ route('data_user_petugas.ubahpw',$data->id) }}"><button class="btn btn-secondary"
