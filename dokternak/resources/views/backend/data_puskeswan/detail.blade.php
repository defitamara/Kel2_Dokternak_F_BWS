              ...
              <div class="ms-auto text-end">
                <nav aria-label="breadcrumb">
                  <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="/dashboard/data_puskeswan">Data Puskeswan</a></li>
            ...
            @foreach ($puskeswan as $item)
              <div class="card-body">
                <div class="card-title">
                  ...
                  <a href="/dashboard/data_puskeswan">Data Puskeswan / </a>
                ...
                <div class="d-flex flex-row comment-row mt-0">
                  <div class="comment-text w-100">
                    ...
                    <div class="comment-footer float-end">
                      <a href="{{ route('data_puskeswan.index') }}"><button
                        type="button"
                        class="btn btn-secondary btn-sm text-white">
                        Kembali
                      </button></a>
                      <a href="{{ route('data_puskeswan.edit',$item->id_puskeswan) }}"><button
                        type="button"
